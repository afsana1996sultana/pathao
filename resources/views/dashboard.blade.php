                            ...
                            <div class="col-lg-4 col-md-5 col-xl-3">
                                ...
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        @if($orders->count() > 0)
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('return.policy') }}" target="_blank"><i class="fi-rs-shopping-bag mr-10"></i>Return request from</a>
                                            </li>
                                            
                                            <li class="nav-item">
                                                <a class="nav-link" id="return-tab" data-bs-toggle="tab" href="#return" role="tab" aria-controls="return" aria-selected="false"><i class="fi-rs-shopping-bag mr-10"></i>Return Products List</a>
                                            </li>
                                            
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('refund.policy') }}" target="_blank"><i class="fi-rs-shopping-bag mr-10"></i>Refund request from</a>
                                            </li>
                                            
                                            <li class="nav-item">
                                                <a class="nav-link" id="refund-tab" data-bs-toggle="tab" href="#refund" role="tab" aria-controls="refund" aria-selected="false"><i class="fi-rs-shopping-bag mr-10"></i>Refund Products List</a>
                                            </li>
                                        @endif
                            ...
                            <div class="col-lg-8 col-xl-9 col-md-7 dashboard">
                                <div class="tab-content account dashboard-content">
                                    ...
                                    <div class="tab-pane fade" id="return" role="tabpanel" aria-labelledby="return-tab">                            
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Your Return Products</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive order__table">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th>Sl</th>
                                                        ...
                                                        <tbody>
                                                            @if($returnProduct->count() > 0)
                                                                @foreach($returnProduct as $key=> $data)
                                                                <tr>
                                                                    <td>{{ $key+1 }}</td>
                                                                    <td>
                                                                        <img src="{{ asset($data->product_img) }}" class="img-sm" alt="Userpic" style="width: 50px; height: 50px;">
                                                                    </td>
                                                                    ...
                                                                    <td>{{ \Carbon\Carbon::parse($data->date)->isoFormat('MMM Do YYYY')}}</td>
                                                                </tr>
                                                                @endforeach
                                                            @else
                                                                <tr>
                                                                    <td colspan="3"></td>
                                                                    <td>
                                                                        <span class="text-center text-danger">Return List is Empty!</span>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
                                    ...
                                    <div class="tab-pane fade" id="refund" role="tabpanel" aria-labelledby="refund-tab">                            
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Your Refund Products</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive order__table">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @if($refundProduct->count() > 0)
                                                                @foreach($refundProduct as $key=> $data)
                                                                <tr>
                                                                    <td>{{ $key+1 }}</td>
                                                                    <td>
                                                                        <img src="{{ asset($data->product_img) }}" class="img-sm" alt="Userpic" style="width: 50px; height: 50px;">
                                    ...
                                    <div class="tab-pane fade" id="address" role="tabpanel"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <a class="dropdown-item address__edit" href="#" data-bs-toggle="modal"
                                        ...
                                        <div class="row mt-3 new__address_userpanel">
                                            <div class="col-lg-6">
